...
namespace Xilium.CefGlue.Interop
{
    ...
    internal unsafe struct cef_print_settings_t
    {
        ...
        #endif
        private delegate int add_ref_delegate(cef_print_settings_t* self);
        ...
        [SuppressUnmanagedCodeSecurity]
        #endif
        private delegate int get_refct_delegate(cef_print_settings_t* self);
        ...
        public static int add_ref(cef_print_settings_t* self)
        {
            add_ref_delegate d;
        ...
        public static int get_refct(cef_print_settings_t* self)
        {
